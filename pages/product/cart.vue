<template>
	...
	<view class="wrap">
		<u-navbar :isBack="false" :border-bottom="false" title="购物车">
			<view class="slot-wrap">
				<view class="icon left">
					<u-icon name="arrow-left" size="35" @click="$u.route({type:'navigateBack'})"></u-icon>
				</view>
				<view class="icon">
					<u-icon name="home" size="35" @click="$u.route({type:'switchTab',url:'/pages/index/index'})">
					</u-icon>
				</view>
			</view>
		</u-navbar>
		...
		<!-- 规格弹出层 -->
		<prodSelect v-model:show="showPop" v-model:prod="cartItem" :isConfirm="false"></prodSelect>
		<!-- 购物车底部 -->
